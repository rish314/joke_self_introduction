...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { hash: @user_profile.hash, job_id: @user_profile.job_id, level_id: @user_profile.level_id, modifier_id: @user_profile.modifier_id, nick_name: @user_profile.nick_name } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { hash: @user_profile.hash, job_id: @user_profile.job_id, level_id: @user_profile.level_id, modifier_id: @user_profile.modifier_id, nick_name: @user_profile.nick_name } }
